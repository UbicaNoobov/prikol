        ...
        <table class="pys_order_meta">
            ...
            <?php if( !isset($sent_to_admin)) : ?>
                <tr >
                    ...
                    <td><?=isset($data['orders_count']) ? $data['orders_count'] : ""?></td>
                </tr>
                <tr >
                    <th>Lifetime value:</th>
                    <td><?=isset($data['ltv']) ? $data['ltv'] : ""?></td>
                </tr>
                <tr >
                    <th>Average order value:</th>
                    <td><?=isset($data['avg_order_value']) ? $data['avg_order_value'] : ""?></td>
                </tr>
            <?php endif; ?>
        </table>
